...
Java_com_example_androidstudy_HardCol_SerialOpen(JNIEnv *env, jclass clazz, jstring path,
...
Java_com_example_androidstudy_HardCol_SerialClose(JNIEnv *env, jclass clazz) {
    int fd;
    if(-1!=serialfd)
        close(serialfd);
